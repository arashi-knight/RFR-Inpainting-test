...
class Config():
    ...
    # mask_json地址
    mask_json_path: str = os.path.join(data_base_path, 'comic_mask_Irregular_json', 'border', '20_30.json')
    # mask_json_data地址
    ...
    # setp学习率衰减间隔
    lr_decay_epoch = epochs//2
    # step学习率衰减幅度
    step_lr_decay_factor = 0.5
